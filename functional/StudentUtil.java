...
public final class StudentUtil {
    ...
    public static Map<Integer, Object> getMapWithObjectWithTwoFields(List<Student> list) {
        return list.stream()
                .collect(Collectors.groupingBy(Student::getCourse, Collectors.collectingAndThen(Collectors.toList(), Object::new)));
    }
